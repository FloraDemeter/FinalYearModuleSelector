...
public class StudentProfile {
	...
	/**
	 * This is to show student details in a certain format for the overview
	 * @return
	 */
	public String printInfo() {
		return "Student P-Number: \t" + studentPnumber + 
				"\nStudent Name: \t\t\t" + studentName.getFullName() +
				"\nStudent E-mail: \t\t" + studentEmail +
				"\nSubmission Date: \t\t" + studentDate +
				"\nStudent Course: \t\t" + studentCourse.toString();
	}
}
